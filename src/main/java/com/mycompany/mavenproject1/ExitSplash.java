...
import com.mycompany.mavenproject1.LoadingSplash.Exit;
...
public class ExitSplash {
     public void doSomething() {
        // Create an instance of the 'Exit' class (assuming 'Exit' is a subclass of JFrame)
        Exit openLog = new Exit();

        // Set the 'Exit' frame as visible to display it on the screen
        ...
        try {
            ...
            for (i = 0; i <= 100; i++) {
                ...
                if (i == 100) {
                    // If the progress is 100%, close (dispose) the 'Exit' frame
                    openLog.dispose();
                }
            }
        } catch (Exception e) {
